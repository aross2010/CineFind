...
import TextInput from '../compenents/multipurpose/SearchBar'
import { RiDeleteBin5Fill } from 'react-icons/ri'
import CheckBox from '../compenents/multipurpose/CheckBox'
import Sort from '../compenents/multipurpose/Sort'
import sortFilms from '../functions/sort-films'
import { useNavigate, useParams } from 'react-router-dom'
import { ThreeDots } from 'react-loader-spinner'
import axios from 'axios'
import DeleteWarning from '../compenents/multipurpose/DeleteWarning'
    ...
    >
      ...
      <button
        className={`square-btn ${
          list && width > 750 ? 'delete-btn-list' : 'submit-btn'
        }`}
        onClick={
          !list ? handleSubmit : width <= 750 ? handleEdit : handleDeleteWarning
        }
        type={!list ? 'submit' : ''}
        disabled={loading}
      >
