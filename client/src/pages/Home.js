...
function Home() {
  ...
  const fetchData = async () => {
    try {
      const reviews = await axios.get('http://localhost:2000/reviews/')
      const discussions = await axios.get('http://localhost:2000/discussions')
      const lists = await axios.get('http://localhost:2000/lists')
