...
import Dropdown from '../compenents/multipurpose/Dropdown'
import { PiCaretRightBold, PiCaretLeftBold } from 'react-icons/pi'
import { BsPersonFill } from 'react-icons/bs'
import getAge from '../functions/get-age'
import useWindowSizeHook from '../hooks/widowSizeHook'
import LoadingSpinner from '../compenents/multipurpose/LoadingSpinner'
      ...
      <div className="additional-info-container">
        ...
        {person.bio.also_known_as.length >= 1 && (
          <div>
            ...
            <ul className="info-text">{additionalNames}</ul>
          </div>
        )}
      </div>
    </>
  ...
  const lrg = person && (
    <>
      ...
      <div className="bio-col">
        ...
        <ul className="person-films-container">
          {displayedJob.label === 'Actor'
            ? renderedActorFilms
            : renderedCrewFilms}
        </ul>
