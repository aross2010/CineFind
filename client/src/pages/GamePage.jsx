...
import Modal from '../compenents/multipurpose/Modal'
  ...
  const saveResults = async (isWin) => {
    try {
      ...
      const res = await axios.put(
        `https://cinefindapi.vercel.app/game/${user._id}`,
        game
      )
    } catch (e) {
      setPopup(e.response.data.error)
  ...
  const content = film && (
    <>
          ...
          >
            ...
            {width > 600 && (
              <div>
                ...
                <ul className="info-text game-genres-container">
                  {renderedGenres}
                </ul>
              </div>
            )}
      ...
      <div
        ...
        className="game-guessed-container"
      >
        {renderedList}
      </div>
          ...
          {isWin ? (
            ...
            >
              ...
              <RiCheckboxCircleFill
                style={{ color: 'var(--green-alt)', fontSize: '1.15rem' }}
              />{' '}
              Winner!
            </span>
          ) : (
            ...
            >
              <RiErrorWarningFill
                style={{ color: 'var(--red-alt)', fontSize: '1.15rem' }}
              />{' '}
              You lose :(
            </span>
          )}
