  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const postedDiscussion = await axios.post(
        `https://cinefindapiapi.vercel.app/comments/${discussionToComment._id}`,
        data
      )
      ...
      const newDiscussions = await axios.get(
        `https://cinefindapiapi.vercel.app/discussions${route}`
      )
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const updatedComment = await axios.put(
        `https://cinefindapiapi.vercel.app/comments/${discussionToComment._id}/${comment._id}`,
        data
      )
